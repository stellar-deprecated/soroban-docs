...
Ensure that you have the Soroban-cli alias installed by running the following command:

```sh
cargo install_soroban
```

Then, Clone the soroban example dapp repo:
...
Next, build the soroban-preview docker image:
...
Be sure that you have properly configured Freighter Wallet by following the instructions [here](../guides/wallets#connect-a-wallet-freighter).
