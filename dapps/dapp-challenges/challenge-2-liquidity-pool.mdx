...
```diff
-const rpcUrl = 'https://soroban-futurenet.stellar.org'
...
Now that your dapp is fully functional locally, it's time to prepare it for deployment on Testnet.
...
> Note: This will remove the existing contracts and initialize new ones on Testnet.
