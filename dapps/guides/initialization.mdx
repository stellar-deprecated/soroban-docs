...
After building, you're ready to deploy the smart contracts to Testnet. To do this, open a terminal in the `soroban-examples/token` directory and execute the following:
