...
The library [`soroban-client`](https://github.com/stellar/js-soroban-client) is a core part of these dapps, enabling integration with the [Soroban RPC](../docs/reference/rpc). This offers the flexibility to build and submit transactions to the Soroban RPC on the Stellar network.
