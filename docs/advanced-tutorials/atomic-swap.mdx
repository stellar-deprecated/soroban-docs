...
sidebar_position: 3
title: Atomic Swap
description: Swap tokens atomically between two parties.
tags:
  - tutorial
  - advanced
---
...
<head>
  <title>Swap tokens atomically between two parties.</title>
  <meta charSet="utf-8" />
  <meta
    property="og:title"
    content="Swap tokens atomically between two parties."
  />
  <meta
  ...
  <link
    rel="canonical"
    href="https://soroban.stellar.org/docs/advanced-tutorials/atomic-swap"
  />
</head>
