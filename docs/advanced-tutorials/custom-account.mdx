...
description: Implement a simple contract that supports multisig and customizable authorization policies; custom accounts can be used with the auth framework and are exclusive to Soroban.
---

<head>
  <title>
    Implement a contract that support multisig and custom auth policies.
  </title>
  <meta charSet="utf-8" />
  <meta name="twitter:card" content="summary" />
  <link
    rel="canonical"
    href="https://soroban.stellar.org/docs/advanced-tutorials/custom-account"
  />
</head>
