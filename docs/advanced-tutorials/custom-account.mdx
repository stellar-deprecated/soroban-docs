...
description: Implement a contract that supports multisig and custom auth policies.
---
...
<head>
  ...
  <meta
    property="og:title"
    content="Implement a contract that supports multisig and custom auth policies."
  />
  <meta
