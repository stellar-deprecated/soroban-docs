...
sidebar_position: 9
title: Fuzz Testing
description: Testing the timelock example with cargo-fuzz.
---
...
[fuzzing example]: https://github.com/stellar/soroban-examples/tree/v0.8.4/fuzzing
...
[timelock example]: https://github.com/stellar/soroban-examples/tree/v0.8.4/timelock
...
[`timelock`]: https://github.com/stellar/soroban-examples/tree/v0.8.4/timelock
...
[contract's manifest]: https://github.com/stellar/soroban-examples/tree/v0.8.4/fuzzing/Cargo.toml
[fuzzing crate's manifest]: https://github.com/stellar/soroban-examples/tree/v0.8.4/fuzzing/fuzz/Cargo.toml
...
[`fuzz_target_1.rs`]: https://github.com/stellar/soroban-examples/tree/v0.8.4/fuzzing/fuzz/fuzz_targets/fuzz_target_1.rs
...
[`fuzz_target_2.rs`]: https://github.com/stellar/soroban-examples/tree/v0.8.4/fuzzing/fuzz/fuzz_targets/fuzz_target_2.rs
...
[`proptest.rs`]: https://github.com/stellar/soroban-examples/tree/v0.8.4/fuzzing/src/proptest.rs
