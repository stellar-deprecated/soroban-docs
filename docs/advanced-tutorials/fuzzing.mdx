...
sidebar_position: 9
title: Fuzz Testing
description: Fuzz test contracts with cargo-fuzz.
---

<head>
  <title>Fuzz test contracts with cargo-fuzz.</title>
  <meta charSet="utf-8" />
  <meta property="og:title" content="Fuzz test contracts with cargo-fuzz." />
  <meta
  ...
  <link
    rel="canonical"
    href="https://soroban.stellar.org/docs/advanced-tutorials/fuzzing"
  />
</head>
