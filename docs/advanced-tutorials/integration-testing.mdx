...
You check out the following [workspace example](https://github.com/stellar/soroban-examples/tree/main/workspace) in the Soroban examples repository that demonstrates the native approach.
