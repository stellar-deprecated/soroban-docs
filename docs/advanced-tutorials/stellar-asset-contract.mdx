...
description: Allows the user to use their Stellar account and trustline balance on Soroban using the Token Interface, which is similar to the ERC-20 token standard.
---
...
<head>
  ...
  <link
    rel="canonical"
    href="https://soroban.stellar.org/docs/advanced-tutorials/stellar-asset-contract"
  />
</head>
...
See the [authorization overview](../fundamentals-and-concepts/authorization.mdx) and
[auth example](../basic-tutorials/auth.mdx) for general information about authorization in
Soroban.
