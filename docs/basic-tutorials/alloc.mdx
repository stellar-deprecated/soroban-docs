...
sidebar_position: 7
title: Allocator
description: Use the allocator feature in a smart contract.
---

<head>
  <title>Use the allocator feature in a smart contract.</title>
  <meta charSet="utf-8" />
  <meta
    property="og:title"
    content="Use the allocator feature in a smart contract."
  />
  <meta
  ...
  <link
    rel="canonical"
    href="https://soroban.stellar.org/docs/basic-tutorials/alloc"
  />
</head>
