...
[custom types example]: https://github.com/stellar/soroban-examples/tree/v0.9.2/custom_types
...
Ref: https://github.com/stellar/soroban-examples/tree/v0.9.2/custom_types
