...
sidebar_position: 1
title: Events
description: Publish events from a contract. Contract events let contracts emit information about what the contract is doing using the environment events publish function.
---
