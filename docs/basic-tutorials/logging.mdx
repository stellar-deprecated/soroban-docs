...
sidebar_position: 3
title: Logging
description: Use logs to debug smart contracts.
---

<head>
  <title>Use logs to debug smart contracts.</title>
  <meta charSet="utf-8" />
  <meta property="og:title" content="Use logs to debug smart contracts." />
  <meta
  ...
  <link
    rel="canonical"
    href="https://soroban.stellar.org/docs/basic-tutorials/logging"
  />
</head>
...
[logging example]: https://github.com/stellar/soroban-examples/tree/v20.0.0-rc2/hello_world
...
Ref: https://github.com/stellar/soroban-examples/tree/v20.0.0-rc2/logging
