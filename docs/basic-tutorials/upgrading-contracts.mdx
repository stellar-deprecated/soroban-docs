...
<head>
  <title>Upgrade a WASM smart contract.</title>
  <meta charSet="utf-8" />
  <meta property="og:title" content="Upgrade a WASM smart contract." />
  <meta
    property="og:description"
    content="Upgrading the WASM bytecode of a deployed contract."
  />
  <link
    rel="canonical"
    href="https://soroban.stellar.org/docs/basic-tutorials/upgrading-contracts"
  />
</head>
...
[upgradeable contract example]: https://github.com/stellar/soroban-examples/tree/v20.0.0-rc2/upgradeable_contract
