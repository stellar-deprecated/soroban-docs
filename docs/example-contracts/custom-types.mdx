...
When defining a contract function types that have been annotated with
`#[contracttype]` can be used as inputs, outputs, and the values can be stored
as contract data and retrieved later.
