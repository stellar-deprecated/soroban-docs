...
[advanced auth example]: https://github.com/stellar/soroban-examples/tree/v0.3.2/auth_advanced
...
soroban-auth = { version = "0.3.1", features = ["testutils"] }
```
...
Ref: https://github.com/stellar/soroban-examples/tree/v0.3.2/auth_advanced
