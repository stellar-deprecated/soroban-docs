...
[advanced auth example]: https://github.com/stellar/soroban-examples/tree/v0.3.1/auth_advanced
...
Ref: https://github.com/stellar/soroban-examples/tree/v0.3.1/auth_advanced
