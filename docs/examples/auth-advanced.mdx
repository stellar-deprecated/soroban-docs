...
This example describes a specific implementation of the general principles of [authorization](../learn/authorization.mdx). 

:::

:::caution 

The [soroban-auth] crate does not provide any functionality to prevent the replay of valid signatures. This example implements a form of [replay prevention](#verifying-the-nonce). Contracts must implement replay prevention that is appropriate for themselves. 
