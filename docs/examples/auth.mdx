...
[events example]: https://github.com/stellar/soroban-examples/tree/v0.3.2/events
...
[auth example]: https://github.com/stellar/soroban-examples/tree/v0.3.2/auth
...
Ref: https://github.com/stellar/soroban-examples/tree/v0.3.2/auth
