...
:::info For contracts that would benefit from supporting auth with presigned invocations, or ed25519 keys independent of accounts and contracts, see the [advanced auth example]. :::
