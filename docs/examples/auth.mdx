...
[events example]: https://github.com/stellar/soroban-examples/tree/v0.3.1/events
...
[auth example]: https://github.com/stellar/soroban-examples/tree/v0.3.1/auth
...
Ref: https://github.com/stellar/soroban-examples/tree/v0.3.1/auth
