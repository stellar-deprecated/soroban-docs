...
This section describes a specific implementation of the general principles discussed in [authorization](../learn/authorization.mdx).
...
:::warning `SignaturePayloadV0` does not include any [replay prevention](#replay-prevention) by default. We recommend using nonce-based replay prevention and including the nonce in the `args`. :::
