...
[cross contract call example]: https://github.com/stellar/soroban-examples/tree/v0.2.1/cross_contract_calls
...
Ref: https://github.com/stellar/soroban-examples/tree/v0.2.1/cross_contract
