...
[deployer example]: https://github.com/stellar/soroban-examples/tree/v0.0.4/deployer
...
Ref: https://github.com/stellar/soroban-examples/tree/v0.0.4/deployer
...
If you have [`soroban`] installed, you can invoke the contract function to
...
```sh
soroban invoke \
    --id e28afe29e3a11a1c1992abc74a9ec6116abb11a348c30bea86e8f17a6bf58666 \
    --fn value
```
