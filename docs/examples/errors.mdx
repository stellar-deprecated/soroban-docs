...
The [errors example] demonstrates how to define and generate errors in a contract that
invokers of the contract can understand and handle.

[errors example]: https://github.com/stellar/soroban-examples/tree/v0.0.4/errors
...
```
Ref: https://github.com/stellar/soroban-examples/tree/v0.0.4/errors

## How it Works

This example is an extension of the [increment example].

[increment example]: increment.mdx
...
value. The error can be passed to the environment using the `panic_error!`
macro.
...
for other contracts and clients to integrate with the contract.
:::
...
Two funtions are generated for every contract function, one that returns a
