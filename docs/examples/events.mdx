...
Ref: https://github.com/stellar/soroban-examples/tree/v0.4.2/events
...
:::info Soroban is a pre-release and at this time outputs events in an unstable JSON format. :::
