...
[hello world example]: https://github.com/stellar/soroban-examples/tree/v0.3.2/hello_world
...
```
Ref: https://github.com/stellar/soroban-examples/tree/v0.3.2/hello_world
