...
- Deploy new contracts using the installed WASM or built-in implementations ( this currently includes only the [token contract](../examples/stellar-asset-contract.mdx)).
