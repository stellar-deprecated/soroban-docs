...
[single offer sale example]: https://github.com/stellar/soroban-examples/tree/v0.3.2/single_offer
[source code]: https://github.com/stellar/soroban-examples/blob/v0.3.2/single_offer/src/lib.rs
