...
[single offer sale example]: https://github.com/stellar/soroban-examples/tree/v0.2.1/single_offer
[source code]: https://github.com/stellar/soroban-examples/blob/v0.2.1/single_offer/src/lib.rs#L131
