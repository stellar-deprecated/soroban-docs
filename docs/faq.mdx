...
Yes. Soroban contains a built-in Stellar Asset Contract that is able to interact with classic trustlines. Read more about this [here](examples/stellar-asset-contract.mdx).
