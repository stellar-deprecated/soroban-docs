...
```js
(async () => {
    const { Keypair, Contract, Server, TransactionBuilder, Networks, BASE_FEE } = require('soroban-client')

    // The source account will be used to sign and send the transaction.
    // GCWY3M4VRW4NXJRI7IVAU3CC7XOPN6PRBG6I5M7TAOQNKZXLT3KAH362
    const sourceKeypair = Keypair.fromSecret('SCQN3XGRO65BHNSWLSHYIR4B65AHLDUQ7YLHGIWQ4677AZFRS77TCZRB')
    ...
    const contractAddress = 'CBEOJUP5FU6KKOEZ7RMTSKZ7YLBS5D6LVATIGCESOGXSZEQ2UWQFKZW6'
