...
For more details on how to use the `alloc` crate, including a hands-on practical exercise, visit the [alloc section](../../basic-tutorials/alloc#how-it-works) of the documentation.
...
Soroban authorization provides Contract-level Authorization, Account Abstraction Functionality, and more advanced Authorization checks. To learn more about these advantages, visit the [Authorization section](../../fundamentals-and-concepts/authorization) of the documentation.
