...
The [Soroban Rust SDK](https://docs.rs/soroban-sdk/latest/soroban_sdk/index.html) supports a variety of [Built-In Types](../../learn/built-in-types) which consist of both Primitive and [Custom Types](../../learn/custom-types), such as:
