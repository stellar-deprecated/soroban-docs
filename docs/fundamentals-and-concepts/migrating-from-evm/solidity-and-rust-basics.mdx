...
The [Soroban Rust SDK](https://docs.rs/soroban-sdk/latest/soroban_sdk/index.html) supports a variety of [Built-In Types](../../fundamentals-and-concepts/built-in-types) which consist of both Primitive and [Custom Types](../../fundamentals-and-concepts/custom-types), such as:
...
To learn more about Rust's Contract Dialect, check out the [Contract Rust Dialect Page](../../fundamentals-and-concepts/rust-dialect).
