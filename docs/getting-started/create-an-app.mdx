...
One of the common problems here is that the contract [expires](../soroban-internals/state-expiration.mdx). To check if this is the problem, you can re-run `npm run reset`.
...
- See more complex example contracts in the [Basic Tutorials](/docs/category/tutorials) and [Advanced Tutorials](/docs/category/tutorials) sections.
