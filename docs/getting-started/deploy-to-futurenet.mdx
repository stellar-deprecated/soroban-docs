...
description: Configure networks and identities, fund accounts with Friendbot, and deploy and interact with smart contracts on a live test network called Futurenet.
---
