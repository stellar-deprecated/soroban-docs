---
sidebar_position: 3
title: 2. Deploy to Test Network
...
<head>
  ...
  <link
    rel="canonical"
    href="https://soroban.stellar.org/docs/getting-started/deploy-to-test-network"
  />
</head>
...
- deploy a contract to a test network (either Testnet or a Standalone network)
