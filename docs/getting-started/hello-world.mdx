...
sidebar_position: 2
title: 1. Hello World
description: Write a simple smart contract in Rust that can be deployed to a Soroban network. Run the contract locally using a sandbox environment and learn to optimize the build.
---
