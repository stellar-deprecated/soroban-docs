...
sidebar_position: 1
title: Setup
description: Get setup to write, deploy, and invoke your first Rust smart contract by installing Rust, installing a target, configuring an editor, and installing a CLI.
---
