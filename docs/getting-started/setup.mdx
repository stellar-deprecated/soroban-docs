...
Install the Soroban CLI using `cargo install`. Prior to installing be sure you have a working Rust installation with at least version 1.74 of the Rust compiler (stellar-xdr v.20 requires this).
