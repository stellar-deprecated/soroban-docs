...
:::info
The version and the sub commands above were generated using soroban-cli 0.4.0.
Future versions of the soroban-cli are expected to have slighly different sub command structure while extending the provided functionality.
:::
