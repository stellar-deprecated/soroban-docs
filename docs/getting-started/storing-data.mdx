...
description: Write a simple contract that stores and retrieves data, reorganize your projects as a multi-contract project using Cargo Workspaces, and learn about different kinds of storage.
---
