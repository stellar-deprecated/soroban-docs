...
[cross contract call example]: https://github.com/stellar/soroban-examples/tree/v0.8.4/cross_contract_calls
...
Ref: https://github.com/stellar/soroban-examples/tree/v0.8.4/cross_contract
...
To build the contract into a `.wasm` file, use the `cargo build` command. Both `contract_call/contract_a` and `contract_call/contract_b` must be built, with `contract_a` being built first.
