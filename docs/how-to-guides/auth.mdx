...
[auth example]: https://github.com/stellar/soroban-examples/tree/v0.7.0/auth
...
Ref: https://github.com/stellar/soroban-examples/tree/v0.7.0/auth
...
[`auth/src/test.rs`]: https://github.com/stellar/soroban-examples/tree/v0.7.0/auth/src/test.rs
