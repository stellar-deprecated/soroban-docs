...
[allocator example]: https://github.com/stellar/soroban-examples/tree/v0.8.4/alloc
...
[dependencies]
soroban-sdk = { version = "0.8.4", features = ["alloc"] }

[dev_dependencies]
soroban-sdk = { version = "0.8.4", features = ["testutils", "alloc"] }
```
...
Ref: https://github.com/stellar/soroban-examples/tree/v0.8.4/alloc
...
[contract rust dialect]: ../../learn/contract-development/rust-dialect.mdx
