...
[deployer example]: https://github.com/stellar/soroban-examples/tree/v0.8.4/deployer
...
Ref: https://github.com/stellar/soroban-examples/tree/v0.8.4/deployer
...
See the [tests](#tests) for an example of installing the contract code in tests. For the actual on-chain installation see the general deployment [tutorial](https://soroban.stellar.org/docs/getting-started/deploy-to-futurenet).
