...
[cross contract call example]: https://github.com/stellar/soroban-examples/tree/v0.6.0/cross_contract
...
- A `Client` type that can be used to invoke functions on the contract.
...
The `contract_a::Client` is constructed pointing at the contract ID
passed in.
