...
[cross contract call example]: https://github.com/stellar/soroban-examples/tree/v0.7.0/cross_contract_calls
...
Ref: https://github.com/stellar/soroban-examples/tree/v0.7.0/cross_contract
...
`contract_call/contract_a` and `contract_call/contract_b` must be built, with Contract A being built first.
