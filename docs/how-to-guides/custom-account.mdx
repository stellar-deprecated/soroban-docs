...
testing and rewview. The example here is *not* a full-fledged account contract -
...
[custom account example]: https://github.com/stellar/soroban-examples/tree/v0.5.0/account
...
[`account/src/test.rs`]: https://github.com/stellar/soroban-examples/tree/v0.5.0/account/src/test.rs
