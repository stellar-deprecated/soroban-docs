...
[custom account example]: https://github.com/stellar/soroban-examples/tree/v0.7.0/account
...
[`account/src/test.rs`]: https://github.com/stellar/soroban-examples/tree/v0.7.0/account/src/test.rs
