...
[custom types example]: https://github.com/stellar/soroban-examples/tree/v0.6.0/custom_types
...
Ref: https://github.com/stellar/soroban-examples/tree/v0.6.0/custom_types
