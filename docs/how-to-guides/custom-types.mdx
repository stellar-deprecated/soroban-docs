...
[custom types example]: https://github.com/stellar/soroban-examples/tree/v0.7.0/custom_types
...
Ref: https://github.com/stellar/soroban-examples/tree/v0.7.0/custom_types
