...
[liquidity pool example]: https://github.com/stellar/soroban-examples/tree/v0.6.0/liquidity_pool
[source code]: https://github.com/stellar/soroban-examples/blob/v0.6.0/liquidity_pool/src/lib.rs#L143
