...
The [Soroban Rust SDK](https://docs.rs/soroban-sdk/0.7.0/soroban_sdk/index.html) supports a variety of [Built-In Types](../../learn/built-in-types) which consist of both Primitive and [Custom Types](../../learn/custom-types), such as:
