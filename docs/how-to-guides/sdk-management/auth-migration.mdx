...
For general information on authorization in Soroban see the [authorization overview](../../learn/contract-development/authorization.mdx) and the [example](../development-basics/auth.mdx).
...
[details]: ../stellar-interactions/invoking-contracts-with-transactions.mdx#authorization-data
