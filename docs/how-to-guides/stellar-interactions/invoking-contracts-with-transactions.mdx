...
Soroban [authorization framework](../learn/authorization.mdx) provides a standardized way for passing authorization data to the contract invocations via `ContractAuth` structures.
