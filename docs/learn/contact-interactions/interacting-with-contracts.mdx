...
See [authorization overview](authorization.mdx) and authorization in transactions [section][auth-data] for general information on Soroban authorization.

[auth-data]: ../how-to-guides/invoking-contracts-with-transactions.mdx#authorization-data
