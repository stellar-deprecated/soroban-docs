...
contract invokation. In a production setting, contract invokation will execute
...
Some contracts, such as the token contract, only export the contract invokation
