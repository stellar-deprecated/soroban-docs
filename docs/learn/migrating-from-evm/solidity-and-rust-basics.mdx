...
The [Soroban Rust SDK](https://docs.rs/soroban-sdk/latest/soroban_sdk/index.html) supports a variety of [Built-In Types](../advanced-topics/built-in-types) which consist of both Primitive and [Custom Types](../advanced-topics/custom-types), such as:
...
To learn more about Rust's Contract Dialect, check out the [Contract Rust Dialect Page](../contract-development/rust-dialect).
