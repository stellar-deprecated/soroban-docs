...
Yes. Soroban contains a built-in Stellar Asset Contract that is able to interact with classic trustlines. Read more about this [here](../../how-to-guides/stellar-interactions/stellar-asset-contract.mdx).
