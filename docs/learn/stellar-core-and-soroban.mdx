---
sidebar_position: 11
title: Using Stellar Core to interact with Soroban
---

Stellar Core has an new Operation named `InvokeHostFunctionOp` that can be used to interact with
Soroban. The [Soroban CLI] abstracts these details away from the
user, but you may find the need to build the XDR transaction and submit it to
...
The xdr of the operation below can be found
[here](https://github.com/stellar/stellar-xdr-next/blob/161e2e5b64425a49f9ccfef7f732ae742ed5eec4/Stellar-transaction.x#L486)
```c++
...
:::danger
InvokeHostFunctionOp is under active-development and is not yet available.
:::
