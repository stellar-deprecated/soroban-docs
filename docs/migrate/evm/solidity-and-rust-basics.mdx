...
The [Soroban Rust SDK](https://docs.rs/soroban-sdk/latest/soroban_sdk/index.html) supports a variety of [Built-In Types](../../soroban-internals/types/built-in-types) which consist of both Primitive and [Custom Types](../../soroban-internals/types/custom-types), such as:
...
To learn more about Rust's Contract Dialect, check out the [Contract Rust Dialect Page](../../soroban-internals/rust-dialect).
