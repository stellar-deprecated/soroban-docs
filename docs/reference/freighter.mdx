...
4. After switching to `Experimental Mode`, you you can use Freighter with Soroban on the Testnet or Futurenet networks. If your account does not exist on the selected network, Freighter will prompt you to fund it the account using Friendbot. Alternatively, you can do so in the Stellar [Laboratory](https://laboratory.stellar.org/#account-creator).
