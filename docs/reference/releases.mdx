...
| Software | Version |
| --- | --- |
| XDR | [0f16673441898162c9996da6117be2280ef8fd84](https://github.com/stellar/stellar-xdr/commit/0f16673441898162c9996da6117be2280ef8fd84) |
| Soroban Environment | `v0.0.17` |
| Soroban Interface Version | `51` |
| Stellar Core | `19.11.1-1373.875f47e24.focal~soroban` |
| Soroban Rust SDK | `v0.9.2` |
| Soroban CLI | `v0.9.1` |
| Soroban RPC | `v0.9.0` |
| Stellar Horizon | `stellar-horizon:2.26.0~soroban-370` |
| Stellar Friendbot | `soroban-v0.0.2-alpha` |
| Stellar Quickstart | `stellar/quickstart:soroban-dev@sha256:ed57f7a7683e3568ae401f5c6e93341a9f77d8ad41191bf752944d7898981e0c` |
