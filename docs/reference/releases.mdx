...
the [migration guide](../how-to-guides/sdk-management/auth-migration.mdx), 
[example](../how-to-guides/development-basics/auth.mdx) and [authorization overview](../learn/contract-development/authorization.mdx)
for more details.
