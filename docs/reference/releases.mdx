...
| Soroban CLI                  | `v0.6.0`                                                                                                                          |
| Soroban RPC                  | `0.6.0-12`                                                                                                                |
| Stellar Horizon              | `stellar-horizon:2.24.6~soroban-323`                                                                                                                |
| Stellar Friendbot            | `soroban-v0.0.2-alpha`                                                                                                            |
| Stellar Quickstart (amd64)   | `Not yet released`                                                                                                                |
| Stellar Quickstart (arm64)   | `Not yet released`                                                                                                                |
