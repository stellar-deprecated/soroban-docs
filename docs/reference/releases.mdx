...
| Stellar Core                 | `20.0.0-1615.617729910.focal`                                                                                                      |
| Soroban Rust SDK             | `v20.0.0`                                                                                                                          |
| Soroban CLI                  | `20.0.0`                                                                                                                           |
| Soroban RPC                  | `v20.0.0`                                                                                                                          |
| Stellar Horizon              | `v2.27.0`                                                                                                                          |
| Stellar Friendbot            | `TBD`                                                                                                                              |
| Stellar Quickstart           | `http://docker.io/stellar/quickstart:soroban-dev@sha256:bc9aa3653b1f3550eb940c8626d525f58967b73458e51024dce8588204698ddf`          |
