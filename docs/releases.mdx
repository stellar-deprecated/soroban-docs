...
| Soroban Rust SDK | `v0.4.1` |
| Soroban CLI | `v0.4.0` |
| Soroban RPC | `0.4.0-9e680fa53ad7b29b5c951cb0ca38c90cdf21cbea` |
| Stellar Horizon | todo:`tbd` |
| Stellar Friendbot | `soroban-v0.0.2-alpha` |
| Stellar Quickstart | todo:`stellar/quickstart:soroban-dev@sha256:8046391718f8e58b2b88b9c379abda3587bb874689fa09b2ed4871a764ebda27` |
