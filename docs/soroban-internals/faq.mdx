...
<head>
  ...
  <link
    rel="canonical"
    href="https://soroban.stellar.org/docs/soroban-internals/faq"
  />
</head>
...
Yes. Soroban contains a built-in Stellar Asset Contract that is able to interact with classic trustlines. Read more about this [here](../tutorials/stellar-asset-contract.mdx).
