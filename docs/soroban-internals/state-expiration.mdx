...
<head>
  ...
  <link
    rel="canonical"
    href="https://soroban.stellar.org/docs/soroban-internals/state-expiration"
  />
</head>
...
[here](../soroban-internals/invoking-contracts-with-transactions.mdx#transaction-resources). To fill
