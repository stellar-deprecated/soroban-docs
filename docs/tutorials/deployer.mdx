...
<head>
  <title>Deploy and initialize a smart contract using another smart contract.</title>
  <meta charSet="utf-8" />
  <meta
    property="og:title"
...
[deployer example]: https://github.com/stellar/soroban-examples/tree/v20.0.0-rc2/deployer
...
Ref: https://github.com/stellar/soroban-examples/tree/v20.0.0-rc2/deployer
