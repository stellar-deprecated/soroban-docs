...
sidebar_position: 1
title: Events
description: Publish events from a contract.
tags:
  - tutorial
  - beginner
---
...
<head>
  <title>Publish events from a contract.</title>
  <meta charSet="utf-8" />
  <meta property="og:title" content="Publish events from a contract." />
  <meta
    property="og:description"
    content="Publish events from a contract. Contract events let contracts emit information about what the contract is doing using the environment events publish function."
  />
  <link
    rel="canonical"
    href="https://soroban.stellar.org/docs/basic-tutorials/events"
  />
</head>
...
[events example]: https://github.com/stellar/soroban-examples/tree/v20.0.0-rc2/events
...
Ref: https://github.com/stellar/soroban-examples/tree/v20.0.0-rc2/events
