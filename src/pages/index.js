    ...
    <Layout>
      <main className='homepage'>
        ...
        <div id="tinker-and-earn" className='hp--cta hp--maxWidth'>
          ...
          <p>
            Between now and December 15, 2022, join <i>Sorobanathon: First Light</i>. Experiment with Soroban and submit a code example, issue, tutorial, blog post, issue, or video documenting your experience. Qualified submissions will receive 250-3,000 XLM. It's a fun, low-lift way to learn, test things out, and provide valuable feedback to both the Soroban development team and the Soroban ecosystem as a whole. Let's bootstrap this thing together!
          </p>
